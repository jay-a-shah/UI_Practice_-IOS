...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if (UserDefaults.standard.bool(forKey: "onBoardScreen") == false){
            if let onBoardingScreen = UIStoryboard(name: Identifiers.onBoardStoryboard.rawValue, bundle: nil).instantiateViewController(withIdentifier: Identifiers.onBoardingViewController.rawValue ) as? OnBoardingViewController {
            ...
            if (UserDefaults.standard.bool(forKey: "isLoggedIn") == false) {
                if let signInScreen = UIStoryboard(name: Identifiers.mainStoryboard.rawValue , bundle: nil).instantiateViewController(withIdentifier: Identifiers.signInViewController.rawValue ) as? SignInViewController {
